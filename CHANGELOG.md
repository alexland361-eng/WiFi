...
- Offline SAE JSON and TSV extraction now preserve decoded BSSID provenance identically, so either tshark output mode can enrich the same AP posture.
...
- 42 focused WPA3 posture, RSN, `iw scan`, control-client audit, offline SAE-capture, configuration-audit, world-model, and assessment-integration tests.
