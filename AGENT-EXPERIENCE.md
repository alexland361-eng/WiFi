...
- Added `docs/WPA3_DRAGONBLOOD.md`, offline SAE capture analysis, Transition Disable extraction, and 50 focused tests.
...
### Verification
- 50 WPA3 tests pass; the current full local suite passes with 884 tests and 70.46% coverage (3 Scapy tests skipped in this rebuilt local environment) against the 68% gate. Ruff is clean and mypy remains at its baseline of 30 findings.
