...
- Added `docs/WPA3_DRAGONBLOOD.md`, offline SAE capture analysis, and 44 focused tests.
...
### Verification
- 43 WPA3 tests pass; the full suite passes with 880 tests and 70.49% coverage against the 68% gate. Ruff is clean and mypy remains at its baseline of 30 findings.
